...
public class MqttHelper {
    ...
    final String clientId = "ThiagoRenan";
    final String subscriptionTopic = "thiago-renan/temperatura";
    final String publishTopic = "thiago-renan/alarme";
    ...
    public void publish(String msg){
        ...
        try {
            mqttAndroidClient.publish(publishTopic, mqttMsg);
